...
namespace XBMCAddon
{
  namespace xbmcgui
  {
    ...
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_QWERTY);
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_NUMERIC);
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_DATE);
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_TIME);
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_IPADDRESS);
    SWIG_CONSTANT_FROM_GETTER(int, INPUT_PASSWORD);

    SWIG_CONSTANT_FROM_GETTER(int, PASSWORD_CHOOSE);
    SWIG_CONSTANT_FROM_GETTER(int, PASSWORD_NUMERIC);
    SWIG_CONSTANT_FROM_GETTER(int, PASSWORD_GAMEPAD);
    SWIG_CONSTANT_FROM_GETTER(int, PASSWORD_QWERTY);
    SWIG_CONSTANT_FROM_GETTER(int, PASSWORD_VERIFY);
    SWIG_CONSTANT_FROM_GETTER(int, QWERTY_HIDE_INPUT);
